...
### Why this structure?
1.  **Shared Logic**: The "Guardian" CLI and the Backend "Audit" workflow share the *same* static analysis rules. Using a shared `libs/core-py` library within a `uv` workspace ensures they use identical logic without code duplication.
