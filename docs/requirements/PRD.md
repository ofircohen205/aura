...
## 2. Problem Statement
Modern engineering teams face velocity and quality bottlenecks due to the disconnect between "how to code" (syntax) and "how *we* code" (architecture).
...
*   **Function**: Analyzes Pull Requests for "architectural drift" and explains *why* changes are needed.
