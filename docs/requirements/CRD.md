...
In modern engineering teams, "how to code" (syntax) is easy, but "how _we_ code" (architecture/patterns) is tribal knowledge.
...
- **In-Flow Education:** Interventions happen _where the work is_ (IDE, CLI, PR).
